...
C     ----------
      ...
      CALL FVOXXX(W(1,4),W(1,7),GWX1N2,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GAX,AMP(1))
      CALL JIOXXX(W(1,6),W(1,2),GZD,ZMASS,ZWIDTH,W(1,10))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N1,MN1,WN1,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,11),W(1,4),W(1,10),GZN12,AMP(2))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N2,MN2,WN2,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL IOVXXX(W(1,11),W(1,4),W(1,10),GZN22,AMP(3))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N3,MN3,WN3,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL IOVCXX(W(1,11),W(1,4),W(1,10),GZN23,AMP(4))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N4,MN4,WN4,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL IOVCXX(W(1,11),W(1,4),W(1,10),GZN24,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL IOVXXX(W(1,3),W(1,9),W(1,10),GZX11,AMP(6))
      CALL FVOXXX(W(1,4),W(1,7),GWX2N2,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL IOVXXX(W(1,3),W(1,9),W(1,10),GZX12,AMP(7))
      CALL JIOXXX(W(1,3),W(1,4),GWX1N2,WMASS,WWIDTH,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL VVVXXX(W(1,7),W(1,9),W(1,8),GWWA,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVVXXX(W(1,7),W(1,9),W(1,10),GWWZ,AMP(9))
      CALL FVIXXX(W(1,6),W(1,7),GWF,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,11),W(1,2),W(1,9),GWF,AMP(10))
      CALL JIOXXX(W(1,5),W(1,2),GWF,WMASS,WWIDTH,W(1,11))
      CALL JIOXXX(W(1,6),W(1,1),GAD,ZERO,AWIDTH,W(1,7))
      CALL FVOXXX(W(1,4),W(1,11),GWX1N2,MX1,WX1,W(1,12))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,3),W(1,12),W(1,7),GAX,AMP(11))
      CALL JIOXXX(W(1,6),W(1,1),GZD,ZMASS,ZWIDTH,W(1,13))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N1,MN1,WN1,W(1,14))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,14),W(1,4),W(1,13),GZN12,AMP(12))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N2,MN2,WN2,W(1,14))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,14),W(1,4),W(1,13),GZN22,AMP(13))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N3,MN3,WN3,W(1,14))
C     Amplitude(s) for diagram number 14
      CALL IOVCXX(W(1,14),W(1,4),W(1,13),GZN23,AMP(14))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N4,MN4,WN4,W(1,14))
C     Amplitude(s) for diagram number 15
      CALL IOVCXX(W(1,14),W(1,4),W(1,13),GZN24,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,3),W(1,12),W(1,13),GZX11,AMP(16))
      CALL FVOXXX(W(1,4),W(1,11),GWX2N2,MX2,WX2,W(1,12))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,3),W(1,12),W(1,13),GZX12,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVVXXX(W(1,11),W(1,9),W(1,7),GWWA,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVVXXX(W(1,11),W(1,9),W(1,13),GWWZ,AMP(19))
      CALL FVIXXX(W(1,6),W(1,11),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,12),W(1,1),W(1,9),GWF,AMP(20))
      CALL FVIXXX(W(1,5),W(1,7),GAU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL IOVXXX(W(1,12),W(1,2),W(1,9),GWF,AMP(21))
      CALL FVIXXX(W(1,5),W(1,9),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,12),W(1,2),W(1,7),GAD,AMP(22))
      CALL FVIXXX(W(1,5),W(1,13),GZU,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,7),W(1,2),W(1,9),GWF,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,12),W(1,2),W(1,13),GZD,AMP(24))
      CALL FVIXXX(W(1,5),W(1,8),GAU,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,13),W(1,1),W(1,9),GWF,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,12),W(1,1),W(1,8),GAD,AMP(26))
      CALL FVIXXX(W(1,5),W(1,10),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,8),W(1,1),W(1,9),GWF,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,12),W(1,1),W(1,10),GZD,AMP(28))
