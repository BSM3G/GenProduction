...
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GWN1X1,AMP(1))
      CALL JIOXXX(W(1,1),W(1,5),GZU,ZMASS,ZWIDTH,W(1,9))
      CALL FVIXXX(W(1,3),W(1,9),GZN11,MN1,WN1,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,10),W(1,4),W(1,8),GWN1X1,AMP(2))
      CALL FVIXXX(W(1,3),W(1,9),GZN12,MN2,WN2,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL IOVXXX(W(1,10),W(1,4),W(1,8),GWN2X1,AMP(3))
      CALL FVIXXX(W(1,3),W(1,9),GZN13,MN3,WN3,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL IOVXXX(W(1,10),W(1,4),W(1,8),GWN3X1,AMP(4))
      CALL FVIXXX(W(1,3),W(1,9),GZN14,MN4,WN4,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL IOVXXX(W(1,10),W(1,4),W(1,8),GWN4X1,AMP(5))
      CALL FVOXXX(W(1,4),W(1,9),GZX11,MX1,WX1,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL IOVXXX(W(1,3),W(1,10),W(1,8),GWN1X1,AMP(6))
      CALL FVOXXX(W(1,4),W(1,9),GZX12,MX2,WX2,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL IOVXXX(W(1,3),W(1,10),W(1,8),GWN1X2,AMP(7))
      CALL JIOXXX(W(1,3),W(1,4),GWN1X1,WMASS,WWIDTH,W(1,10))
