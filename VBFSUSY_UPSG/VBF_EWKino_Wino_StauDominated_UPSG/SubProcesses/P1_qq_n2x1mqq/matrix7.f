...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,2),GWF,WMASS,WWIDTH,W(1,8))
      CALL FVOXXX(W(1,4),W(1,7),GAX,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GWN2X1,AMP(1))
      CALL JIOXXX(W(1,5),W(1,1),GZU,ZMASS,ZWIDTH,W(1,9))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FVIXXX(W(1,6),W(1,7),GAD,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,11),W(1,2),W(1,10),GWF,AMP(10))
      CALL FVOXXX(W(1,2),W(1,7),GAU,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,6),W(1,11),W(1,10),GWF,AMP(11))
      CALL FVIXXX(W(1,6),W(1,9),GZD,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,11),W(1,2),W(1,10),GWF,AMP(12))
      CALL FVOXXX(W(1,2),W(1,9),GZU,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,6),W(1,11),W(1,10),GWF,AMP(13))
      CALL JIOXXX(W(1,5),W(1,2),GAU,ZERO,AWIDTH,W(1,11))
      CALL JIOXXX(W(1,6),W(1,1),GWF,WMASS,WWIDTH,W(1,9))
      CALL FVOXXX(W(1,4),W(1,11),GAX,MX1,WX1,W(1,7))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,3),W(1,7),W(1,9),GWN2X1,AMP(14))
      CALL JIOXXX(W(1,5),W(1,2),GZU,ZMASS,ZWIDTH,W(1,7))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FVIXXX(W(1,6),W(1,11),GAD,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,12),W(1,1),W(1,10),GWF,AMP(23))
      CALL FVOXXX(W(1,1),W(1,11),GAU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,6),W(1,12),W(1,10),GWF,AMP(24))
      CALL FVIXXX(W(1,6),W(1,7),GZD,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,12),W(1,1),W(1,10),GWF,AMP(25))
      CALL FVOXXX(W(1,1),W(1,7),GZU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,6),W(1,12),W(1,10),GWF,AMP(26))
      CALL FVIXXX(W(1,5),W(1,9),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,12),W(1,2),W(1,10),GWF,AMP(27))
      CALL FVIXXX(W(1,5),W(1,8),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,12),W(1,1),W(1,10),GWF,AMP(28))
