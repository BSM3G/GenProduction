...
C     Amplitude(s) for diagram number 1
      ...
      CALL JIOXXX(W(1,6),W(1,5),GZD,ZMASS,ZWIDTH,W(1,10))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FVOXXX(W(1,5),W(1,7),GWF,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL JIOXXX(W(1,1),W(1,5),GZD,ZMASS,ZWIDTH,W(1,12))
...
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,13),W(1,2),W(1,9),GWF,AMP(20))
...
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,13),W(1,2),W(1,9),GWF,AMP(22))
