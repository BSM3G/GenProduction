...
C     Amplitude(s) for diagram number 9
      CALL IOVXXX(W(1,11),W(1,2),W(1,9),GAU,AMP(9))
      CALL FVOXXX(W(1,2),W(1,7),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,1),W(1,4),W(1,9),GAD,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,11),W(1,2),W(1,10),GZU,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,1),W(1,4),W(1,10),GZD,AMP(12))
      CALL FVIXXX(W(1,6),W(1,8),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,4),W(1,5),W(1,9),GAD,AMP(13))
      CALL FVIXXX(W(1,6),W(1,9),GAU,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,1),W(1,5),W(1,8),GWF,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,4),W(1,5),W(1,10),GZD,AMP(15))
      CALL FVIXXX(W(1,6),W(1,10),GZU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,4),W(1,5),W(1,8),GWF,AMP(16))
