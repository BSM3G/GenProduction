...
C     Amplitude(s) for diagram number 21
      CALL IOVXXX(W(1,9),W(1,5),W(1,12),GAD,AMP(21))
      CALL FVIXXX(W(1,1),W(1,12),GAD,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,2),W(1,5),W(1,8),GAD,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,9),W(1,5),W(1,7),GZD,AMP(23))
      CALL FVIXXX(W(1,1),W(1,7),GZD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,9),W(1,5),W(1,8),GAD,AMP(24))
      CALL FVIXXX(W(1,1),W(1,11),GZD,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,8),W(1,5),W(1,12),GAD,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,2),W(1,5),W(1,11),GZD,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,8),W(1,5),W(1,7),GZD,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,9),W(1,5),W(1,11),GZD,AMP(28))
