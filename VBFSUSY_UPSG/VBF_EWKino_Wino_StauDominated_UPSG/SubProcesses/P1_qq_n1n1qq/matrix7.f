...
C     Amplitude(s) for diagram number 14
      ...
      CALL FVOXXX(W(1,3),W(1,13),GWX1N1,MX1,WX1,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,4),W(1,11),W(1,7),GWN1X1,AMP(15))
      CALL FVOXXX(W(1,3),W(1,13),GWX2N1,MX2,WX2,W(1,11))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,4),W(1,11),W(1,7),GWN1X2,AMP(16))
      CALL FVICXX(W(1,4),W(1,13),GWX1N1,MX1,WX1,W(1,11))
C     Amplitude(s) for diagram number 17
      CALL IOVCXX(W(1,11),W(1,3),W(1,7),GWN1X1,AMP(17))
      CALL FVICXX(W(1,4),W(1,13),GWX2N1,MX2,WX2,W(1,11))
C     Amplitude(s) for diagram number 18
      CALL IOVCXX(W(1,11),W(1,3),W(1,7),GWN1X2,AMP(18))
