...
C     ----------
      ...
      CALL FVOXXX(W(1,4),W(1,7),GWX1N1,MX1,WX1,W(1,9))
...
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,11),W(1,4),W(1,10),GZN11,AMP(2))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N2,MN2,WN2,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL IOVCXX(W(1,11),W(1,4),W(1,10),GZN12,AMP(3))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N3,MN3,WN3,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL IOVCXX(W(1,11),W(1,4),W(1,10),GZN13,AMP(4))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N4,MN4,WN4,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL IOVCXX(W(1,11),W(1,4),W(1,10),GZN14,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL IOVXXX(W(1,3),W(1,9),W(1,10),GZX11,AMP(6))
      CALL FVOXXX(W(1,4),W(1,7),GWX2N1,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL IOVXXX(W(1,3),W(1,9),W(1,10),GZX12,AMP(7))
      CALL JIOXXX(W(1,3),W(1,4),GWX1N1,WMASS,WWIDTH,W(1,9))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FVOXXX(W(1,4),W(1,11),GWX1N1,MX1,WX1,W(1,12))
...
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,14),W(1,4),W(1,13),GZN11,AMP(12))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N2,MN2,WN2,W(1,14))
C     Amplitude(s) for diagram number 13
      CALL IOVCXX(W(1,14),W(1,4),W(1,13),GZN12,AMP(13))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N3,MN3,WN3,W(1,14))
C     Amplitude(s) for diagram number 14
      CALL IOVCXX(W(1,14),W(1,4),W(1,13),GZN13,AMP(14))
      CALL FVIXXX(W(1,3),W(1,11),GWX1N4,MN4,WN4,W(1,14))
C     Amplitude(s) for diagram number 15
      CALL IOVCXX(W(1,14),W(1,4),W(1,13),GZN14,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,3),W(1,12),W(1,13),GZX11,AMP(16))
      CALL FVOXXX(W(1,4),W(1,11),GWX2N1,MX2,WX2,W(1,12))
