...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,1),GAD,ZERO,AWIDTH,W(1,8))
      CALL FVOXXX(W(1,4),W(1,7),GWX1N1,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GAX,AMP(1))
      CALL JIOXXX(W(1,6),W(1,1),GZD,ZMASS,ZWIDTH,W(1,10))
...
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,4),W(1,1),W(1,9),GWF,AMP(10))
      CALL FVIXXX(W(1,5),W(1,8),GAU,ZERO,ZERO,W(1,4))
