...
C     
C     Process: u u > x1+ n1 u d QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c c > x1+ n1 c s QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u d > x1+ n1 d d QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c s > x1+ n1 s s QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u u~ > x1+ n1 d u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c c~ > x1+ n1 s c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u d~ > x1+ n1 u u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c s~ > x1+ n1 c c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u d~ > x1+ n1 d d~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c s~ > x1+ n1 s s~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d d~ > x1+ n1 d u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: s s~ > x1+ n1 s c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u~ d~ > x1+ n1 u~ u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c~ s~ > x1+ n1 c~ c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d~ d~ > x1+ n1 u~ d~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: s~ s~ > x1+ n1 c~ s~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u c > x1+ n1 u s QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u c > x1+ n1 c d QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u s > x1+ n1 d s QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c d > x1+ n1 s d QCD=0 / go dl dr ul ur sl sr cl cr b1
C      b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u u~ > x1+ n1 s c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c c~ > x1+ n1 d u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u c~ > x1+ n1 d c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c u~ > x1+ n1 s u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u d~ > x1+ n1 c c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c s~ > x1+ n1 u u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u d~ > x1+ n1 s s~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c s~ > x1+ n1 d d~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u s~ > x1+ n1 u c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c d~ > x1+ n1 c u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u s~ > x1+ n1 d s~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c d~ > x1+ n1 s d~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d d~ > x1+ n1 s c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: s s~ > x1+ n1 d u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d s~ > x1+ n1 d c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: s d~ > x1+ n1 s u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: u~ s~ > x1+ n1 u~ c~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: c~ d~ > x1+ n1 c~ u~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d~ s~ > x1+ n1 u~ s~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     Process: d~ s~ > x1+ n1 c~ d~ QCD=0 / go dl dr ul ur sl sr cl cr
C      b1 b2 t1 t2 dl dr ul ur sl sr cl cr b1 b2 t1 t2 @1
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > x1+ n1 u d
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u d > x1+ n1 d d
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u u~ > x1+ n1 d u~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u d~ > x1+ n1 u u~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u d~ > x1+ n1 d d~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! d d~ > x1+ n1 d u~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u~ d~ > x1+ n1 u~ u~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! d~ d~ > x1+ n1 u~ d~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u c > x1+ n1 u s
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u c > x1+ n1 c d
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u s > x1+ n1 d s
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u u~ > x1+ n1 s c~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u c~ > x1+ n1 d c~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u d~ > x1+ n1 c c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u d~ > x1+ n1 s s~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u s~ > x1+ n1 u c~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u s~ > x1+ n1 d s~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! d d~ > x1+ n1 s c~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! d s~ > x1+ n1 d c~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! u~ s~ > x1+ n1 u~ c~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! d~ s~ > x1+ n1 u~ s~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! d~ s~ > x1+ n1 c~ d~
      ENDIF
