...
C     Amplitude(s) for diagram number 14
      ...
      CALL JIOXXX(W(1,5),W(1,2),GWF,WMASS,WWIDTH,W(1,13))
      CALL JIOXXX(W(1,6),W(1,1),GWF,WMASS,WWIDTH,W(1,7))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FVIXXX(W(1,6),W(1,13),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,10),W(1,1),W(1,12),GZU,AMP(22))
      CALL FVOXXX(W(1,1),W(1,13),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,6),W(1,10),W(1,12),GZD,AMP(23))
      CALL FVIXXX(W(1,5),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,10),W(1,2),W(1,12),GZD,AMP(24))
      CALL FVIXXX(W(1,5),W(1,12),GZU,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,10),W(1,2),W(1,7),GWF,AMP(25))
...
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,6),W(1,1),W(1,12),GZU,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,10),W(1,1),W(1,7),GAU,AMP(27))
      CALL FVIXXX(W(1,5),W(1,8),GZU,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,7),W(1,1),W(1,12),GZU,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL IOVXXX(W(1,10),W(1,1),W(1,8),GZU,AMP(29))
