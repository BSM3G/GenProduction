...
C     Amplitude(s) for diagram number 14
      ...
      CALL JIOXXX(W(1,1),W(1,6),GWF,WMASS,WWIDTH,W(1,13))
      CALL JIOXXX(W(1,2),W(1,5),GWF,WMASS,WWIDTH,W(1,7))
      CALL FVICXX(W(1,3),W(1,13),GWX1N2,MX1,WX1,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL IOVCXX(W(1,11),W(1,4),W(1,7),GWN2X1,AMP(15))
      CALL FVICXX(W(1,3),W(1,13),GWX2N2,MX2,WX2,W(1,11))
C     Amplitude(s) for diagram number 16
      CALL IOVCXX(W(1,11),W(1,4),W(1,7),GWN2X2,AMP(16))
      CALL FVOXXX(W(1,4),W(1,13),GWX1N2,MX1,WX1,W(1,11))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,3),W(1,11),W(1,7),GWN2X1,AMP(17))
      CALL FVOXXX(W(1,4),W(1,13),GWX2N2,MX2,WX2,W(1,11))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,3),W(1,11),W(1,7),GWN2X2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVVXXX(W(1,13),W(1,7),W(1,12),GWWZ,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVSXXX(W(1,13),W(1,7),W(1,9),GWWH1,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL VVSXXX(W(1,13),W(1,7),W(1,10),GWWH2,AMP(21))
      CALL FVIXXX(W(1,2),W(1,13),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,10),W(1,5),W(1,12),GZU,AMP(22))
      CALL FVOXXX(W(1,5),W(1,13),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,2),W(1,10),W(1,12),GZD,AMP(23))
      CALL FVIXXX(W(1,1),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,10),W(1,6),W(1,12),GZD,AMP(24))
      CALL FVIXXX(W(1,1),W(1,12),GZU,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,10),W(1,6),W(1,7),GWF,AMP(25))
...
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,6),W(1,5),W(1,12),GZU,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,10),W(1,5),W(1,7),GAU,AMP(27))
      CALL FVIXXX(W(1,1),W(1,8),GZU,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,7),W(1,5),W(1,12),GZU,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL IOVXXX(W(1,10),W(1,5),W(1,8),GZU,AMP(29))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)
     $ -AMP(8)-AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)-AMP(26)
     $ -AMP(27)-AMP(28)-AMP(29)
