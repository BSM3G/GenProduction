...
C     Amplitude(s) for diagram number 7
      ...
      CALL FVIXXX(W(1,2),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL IOVXXX(W(1,10),W(1,5),W(1,9),GZU,AMP(8))
      CALL FVOXXX(W(1,5),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
      CALL IOVXXX(W(1,2),W(1,10),W(1,9),GZD,AMP(9))
      CALL FVIXXX(W(1,1),W(1,8),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,10),W(1,6),W(1,9),GZD,AMP(10))
      CALL FVIXXX(W(1,1),W(1,9),GZU,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,10),W(1,6),W(1,8),GWF,AMP(11))
