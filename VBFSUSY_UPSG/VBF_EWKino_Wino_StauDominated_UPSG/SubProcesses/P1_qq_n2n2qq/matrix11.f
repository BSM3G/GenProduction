...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,5),GZU,ZMASS,ZWIDTH,W(1,7))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL JIOXXX(W(1,6),W(1,5),GAU,ZERO,AWIDTH,W(1,11))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL JIOXXX(W(1,6),W(1,2),GWF,WMASS,WWIDTH,W(1,13))
...
C     Amplitude(s) for diagram number 25
      ...
      CALL FVIXXX(W(1,6),W(1,7),GAU,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,2),W(1,5),W(1,12),GZU,AMP(26))
