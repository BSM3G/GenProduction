...
C     Amplitude(s) for diagram number 9
      ...
      CALL HIOXXX(W(1,3),W(1,4),GH2N22,MH2,WH2,W(1,9))
C     Amplitude(s) for diagram number 10
      CALL VVSXXX(W(1,7),W(1,8),W(1,9),GZZH2,AMP(10))
      CALL JIOXXX(W(1,1),W(1,5),GAU,ZERO,AWIDTH,W(1,9))
      CALL JIOXXX(W(1,3),W(1,4),GZN22,ZMASS,ZWIDTH,W(1,10))
      CALL FVIXXX(W(1,6),W(1,9),GAD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,4),W(1,2),W(1,10),GZD,AMP(11))
      CALL FVOXXX(W(1,2),W(1,9),GAD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,6),W(1,4),W(1,10),GZD,AMP(12))
      CALL FVIXXX(W(1,6),W(1,7),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,4),W(1,2),W(1,10),GZD,AMP(13))
      CALL FVOXXX(W(1,2),W(1,7),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,6),W(1,4),W(1,10),GZD,AMP(14))
      CALL JIOXXX(W(1,6),W(1,2),GAD,ZERO,AWIDTH,W(1,4))
      CALL FVIXXX(W(1,1),W(1,4),GAU,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,6),W(1,5),W(1,10),GZU,AMP(15))
      CALL FVIXXX(W(1,1),W(1,10),GZU,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,6),W(1,5),W(1,4),GAU,AMP(16))
      CALL FVIXXX(W(1,1),W(1,8),GZU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,4),W(1,5),W(1,10),GZU,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,6),W(1,5),W(1,8),GZU,AMP(18))
