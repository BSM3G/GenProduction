...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,5),GZU,ZMASS,ZWIDTH,W(1,8))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL JIOXXX(W(1,1),W(1,5),GAU,ZERO,AWIDTH,W(1,10))
      CALL FVIXXX(W(1,6),W(1,10),GAU,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,9),W(1,2),W(1,12),GZU,AMP(25))
      CALL FVOXXX(W(1,2),W(1,10),GAU,ZERO,ZERO,W(1,9))
