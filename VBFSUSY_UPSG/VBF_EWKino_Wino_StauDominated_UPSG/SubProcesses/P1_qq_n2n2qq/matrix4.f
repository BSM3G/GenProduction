...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,5),GZD,ZMASS,ZWIDTH,W(1,8))
...
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,9),W(1,2),W(1,12),GZD,AMP(25))
      CALL FVOXXX(W(1,2),W(1,10),GAD,ZERO,ZERO,W(1,9))
