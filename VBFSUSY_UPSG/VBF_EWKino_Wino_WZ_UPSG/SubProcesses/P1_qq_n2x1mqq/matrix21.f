...
C     ----------
      ...
      CALL JIOXXX(W(1,5),W(1,2),GAU,ZERO,AWIDTH,W(1,7))
      CALL JIOXXX(W(1,6),W(1,1),GWF,WMASS,WWIDTH,W(1,8))
      CALL FVOXXX(W(1,4),W(1,7),GAX,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GWN2X1,AMP(1))
      CALL JIOXXX(W(1,5),W(1,2),GZU,ZMASS,ZWIDTH,W(1,9))
...
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,4),W(1,1),W(1,10),GWF,AMP(10))
      CALL FVOXXX(W(1,1),W(1,7),GAU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,6),W(1,4),W(1,10),GWF,AMP(11))
      CALL FVIXXX(W(1,6),W(1,9),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,4),W(1,1),W(1,10),GWF,AMP(12))
      CALL FVOXXX(W(1,1),W(1,9),GZU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,6),W(1,4),W(1,10),GWF,AMP(13))
      CALL FVIXXX(W(1,5),W(1,8),GWF,ZERO,ZERO,W(1,4))
