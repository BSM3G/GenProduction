...
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,4),W(1,9),W(1,8),GWN1X1,AMP(1))
      CALL FVOXXX(W(1,3),W(1,7),GWX2N1,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,4),W(1,9),W(1,8),GWN1X2,AMP(2))
      CALL FVICXX(W(1,4),W(1,7),GWX1N1,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL IOVCXX(W(1,9),W(1,3),W(1,8),GWN1X1,AMP(3))
      CALL FVICXX(W(1,4),W(1,7),GWX2N1,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL IOVCXX(W(1,9),W(1,3),W(1,8),GWN1X2,AMP(4))
      CALL JIOXXX(W(1,4),W(1,3),GZN11,ZMASS,ZWIDTH,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL VVVXXX(W(1,7),W(1,8),W(1,9),GWWZ,AMP(5))
      CALL HIOXXX(W(1,4),W(1,3),GH1N11,MH1,WH1,W(1,10))
