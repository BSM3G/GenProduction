...
C     ----------
      ...
      CALL JIOXXX(W(1,2),W(1,5),GWF,WMASS,WWIDTH,W(1,8))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N1,MN1,WN1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,9),W(1,4),W(1,8),GWN1X1,AMP(1))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N2,MN2,WN2,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,9),W(1,4),W(1,8),GWN2X1,AMP(2))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N3,MN3,WN3,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL IOVXXX(W(1,9),W(1,4),W(1,8),GWN3X1,AMP(3))
      CALL FVIXXX(W(1,3),W(1,7),GWX1N4,MN4,WN4,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL IOVXXX(W(1,9),W(1,4),W(1,8),GWN4X1,AMP(4))
      CALL JIOXXX(W(1,3),W(1,4),GAX,ZERO,AWIDTH,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL VVVXXX(W(1,7),W(1,8),W(1,9),GWWA,AMP(5))
      CALL JIOXXX(W(1,3),W(1,4),GZX11,ZMASS,ZWIDTH,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL VVVXXX(W(1,7),W(1,8),W(1,10),GWWZ,AMP(6))
      CALL HIOXXX(W(1,3),W(1,4),GH1X11,MH1,WH1,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL VVSXXX(W(1,7),W(1,8),W(1,11),GWWH1,AMP(7))
      CALL HIOXXX(W(1,3),W(1,4),GH2X11,MH2,WH2,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL VVSXXX(W(1,7),W(1,8),W(1,11),GWWH2,AMP(8))
      CALL FVIXXX(W(1,2),W(1,7),GWF,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL IOVXXX(W(1,11),W(1,5),W(1,9),GAU,AMP(9))
      CALL FVOXXX(W(1,5),W(1,7),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,2),W(1,4),W(1,9),GAD,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,11),W(1,5),W(1,10),GZU,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,2),W(1,4),W(1,10),GZD,AMP(12))
      CALL FVIXXX(W(1,1),W(1,8),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,4),W(1,6),W(1,9),GAD,AMP(13))
      CALL FVIXXX(W(1,1),W(1,9),GAU,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,2),W(1,6),W(1,8),GWF,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GZD,AMP(15))
      CALL FVIXXX(W(1,1),W(1,10),GZU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,4),W(1,6),W(1,8),GWF,AMP(16))
