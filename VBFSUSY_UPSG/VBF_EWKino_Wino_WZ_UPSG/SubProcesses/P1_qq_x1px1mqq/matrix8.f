...
C     Amplitude(s) for diagram number 20
      ...
      CALL JIOXXX(W(1,1),W(1,5),GWF,WMASS,WWIDTH,W(1,14))
      CALL JIOXXX(W(1,6),W(1,2),GWF,WMASS,WWIDTH,W(1,15))
...
C     Amplitude(s) for diagram number 34
      CALL IOVXXX(W(1,6),W(1,5),W(1,15),GWF,AMP(34))
...
C     Amplitude(s) for diagram number 38
      CALL IOVXXX(W(1,6),W(1,2),W(1,8),GAU,AMP(38))
...
C     Amplitude(s) for diagram number 42
      CALL IOVXXX(W(1,6),W(1,2),W(1,11),GZU,AMP(42))
