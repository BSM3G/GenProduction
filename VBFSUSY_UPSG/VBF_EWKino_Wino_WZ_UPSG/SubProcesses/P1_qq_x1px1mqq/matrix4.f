...
C     ----------
      ...
      CALL JIOXXX(W(1,6),W(1,5),GAD,ZERO,AWIDTH,W(1,8))
...
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,14),W(1,5),W(1,13),GAD,AMP(13))
      CALL FVOXXX(W(1,5),W(1,7),GAD,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,6),W(1,15),W(1,13),GAD,AMP(14))
      CALL JIOXXX(W(1,3),W(1,4),GZX11,ZMASS,ZWIDTH,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,14),W(1,5),W(1,7),GZD,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,6),W(1,15),W(1,7),GZD,AMP(16))
      CALL FVIXXX(W(1,6),W(1,10),GZD,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,15),W(1,5),W(1,13),GAD,AMP(17))
      CALL FVOXXX(W(1,5),W(1,10),GZD,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,6),W(1,14),W(1,13),GAD,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL IOVXXX(W(1,15),W(1,5),W(1,7),GZD,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,6),W(1,14),W(1,7),GZD,AMP(20))
      CALL JIOXXX(W(1,1),W(1,5),GAD,ZERO,AWIDTH,W(1,14))
      CALL JIOXXX(W(1,6),W(1,2),GAD,ZERO,AWIDTH,W(1,15))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FVIXXX(W(1,6),W(1,14),GAD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL IOVXXX(W(1,9),W(1,2),W(1,13),GAD,AMP(33))
      CALL FVOXXX(W(1,2),W(1,14),GAD,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 34
      CALL IOVXXX(W(1,6),W(1,12),W(1,13),GAD,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL IOVXXX(W(1,9),W(1,2),W(1,7),GZD,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL IOVXXX(W(1,6),W(1,12),W(1,7),GZD,AMP(36))
      CALL FVIXXX(W(1,6),W(1,16),GZD,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 37
      CALL IOVXXX(W(1,12),W(1,2),W(1,13),GAD,AMP(37))
      CALL FVOXXX(W(1,2),W(1,16),GZD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 38
      CALL IOVXXX(W(1,6),W(1,9),W(1,13),GAD,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL IOVXXX(W(1,12),W(1,2),W(1,7),GZD,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL IOVXXX(W(1,6),W(1,9),W(1,7),GZD,AMP(40))
      CALL FVIXXX(W(1,1),W(1,15),GAD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 41
      CALL IOVXXX(W(1,9),W(1,5),W(1,13),GAD,AMP(41))
      CALL FVIXXX(W(1,1),W(1,13),GAD,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 42
      CALL IOVXXX(W(1,6),W(1,5),W(1,15),GAD,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL IOVXXX(W(1,9),W(1,5),W(1,7),GZD,AMP(43))
      CALL FVIXXX(W(1,1),W(1,7),GZD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 44
      CALL IOVXXX(W(1,9),W(1,5),W(1,15),GAD,AMP(44))
      CALL FVIXXX(W(1,1),W(1,17),GZD,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 45
      CALL IOVXXX(W(1,15),W(1,5),W(1,13),GAD,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL IOVXXX(W(1,6),W(1,5),W(1,17),GZD,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL IOVXXX(W(1,15),W(1,5),W(1,7),GZD,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL IOVXXX(W(1,9),W(1,5),W(1,17),GZD,AMP(48))
      CALL FVIXXX(W(1,1),W(1,8),GAD,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 49
      CALL IOVXXX(W(1,17),W(1,2),W(1,13),GAD,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL IOVXXX(W(1,6),W(1,2),W(1,8),GAD,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL IOVXXX(W(1,17),W(1,2),W(1,7),GZD,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL IOVXXX(W(1,9),W(1,2),W(1,8),GAD,AMP(52))
      CALL FVIXXX(W(1,1),W(1,11),GZD,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 53
      CALL IOVXXX(W(1,8),W(1,2),W(1,13),GAD,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL IOVXXX(W(1,6),W(1,2),W(1,11),GZD,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL IOVXXX(W(1,8),W(1,2),W(1,7),GZD,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL IOVXXX(W(1,9),W(1,2),W(1,11),GZD,AMP(56))
