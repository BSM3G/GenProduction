...
C     ----------
      ...
      CALL JIOXXX(W(1,1),W(1,2),GAU,ZERO,AWIDTH,W(1,7))
      CALL JIOXXX(W(1,6),W(1,5),GAU,ZERO,AWIDTH,W(1,8))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FVIXXX(W(1,6),W(1,7),GAU,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,14),W(1,5),W(1,13),GAU,AMP(13))
      CALL FVOXXX(W(1,5),W(1,7),GAU,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,6),W(1,15),W(1,13),GAU,AMP(14))
      CALL JIOXXX(W(1,3),W(1,4),GZX11,ZMASS,ZWIDTH,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,14),W(1,5),W(1,7),GZU,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,6),W(1,15),W(1,7),GZU,AMP(16))
      CALL FVIXXX(W(1,6),W(1,10),GZU,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,15),W(1,5),W(1,13),GAU,AMP(17))
      CALL FVOXXX(W(1,5),W(1,10),GZU,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,6),W(1,14),W(1,13),GAU,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL IOVXXX(W(1,15),W(1,5),W(1,7),GZU,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,6),W(1,14),W(1,7),GZU,AMP(20))
      CALL JIOXXX(W(1,1),W(1,5),GAU,ZERO,AWIDTH,W(1,14))
      CALL JIOXXX(W(1,6),W(1,2),GAU,ZERO,AWIDTH,W(1,15))
      CALL FVIXXX(W(1,3),W(1,14),GAX,MX1,WX1,W(1,10))
C     Amplitude(s) for diagram number 21
      CALL IOVXXX(W(1,10),W(1,4),W(1,15),GAX,AMP(21))
      CALL FVOXXX(W(1,4),W(1,14),GAX,MX1,WX1,W(1,16))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,3),W(1,16),W(1,15),GAX,AMP(22))
      CALL JIOXXX(W(1,6),W(1,2),GZU,ZMASS,ZWIDTH,W(1,17))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,10),W(1,4),W(1,17),GZX11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,3),W(1,16),W(1,17),GZX11,AMP(24))
      CALL JIOXXX(W(1,1),W(1,5),GZU,ZMASS,ZWIDTH,W(1,16))
      CALL FVIXXX(W(1,3),W(1,16),GZX11,MX1,WX1,W(1,10))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,10),W(1,4),W(1,15),GAX,AMP(25))
      CALL FVOXXX(W(1,4),W(1,16),GZX11,MX1,WX1,W(1,18))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,3),W(1,18),W(1,15),GAX,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,10),W(1,4),W(1,17),GZX11,AMP(27))
      CALL FVIXXX(W(1,3),W(1,16),GZX12,MX2,WX2,W(1,10))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,10),W(1,4),W(1,17),GZX12,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL IOVXXX(W(1,3),W(1,18),W(1,17),GZX11,AMP(29))
      CALL FVOXXX(W(1,4),W(1,16),GZX12,MX2,WX2,W(1,18))
C     Amplitude(s) for diagram number 30
      CALL IOVXXX(W(1,3),W(1,18),W(1,17),GZX12,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL VVSXXX(W(1,16),W(1,17),W(1,12),GZZH1,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL VVSXXX(W(1,16),W(1,17),W(1,9),GZZH2,AMP(32))
      CALL FVIXXX(W(1,6),W(1,14),GAU,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL IOVXXX(W(1,9),W(1,2),W(1,13),GAU,AMP(33))
      CALL FVOXXX(W(1,2),W(1,14),GAU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 34
      CALL IOVXXX(W(1,6),W(1,12),W(1,13),GAU,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL IOVXXX(W(1,9),W(1,2),W(1,7),GZU,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL IOVXXX(W(1,6),W(1,12),W(1,7),GZU,AMP(36))
      CALL FVIXXX(W(1,6),W(1,16),GZU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 37
      CALL IOVXXX(W(1,12),W(1,2),W(1,13),GAU,AMP(37))
      CALL FVOXXX(W(1,2),W(1,16),GZU,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 38
      CALL IOVXXX(W(1,6),W(1,9),W(1,13),GAU,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL IOVXXX(W(1,12),W(1,2),W(1,7),GZU,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL IOVXXX(W(1,6),W(1,9),W(1,7),GZU,AMP(40))
      CALL FVIXXX(W(1,1),W(1,15),GAU,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 41
      CALL IOVXXX(W(1,9),W(1,5),W(1,13),GAU,AMP(41))
      CALL FVIXXX(W(1,1),W(1,13),GAU,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 42
      CALL IOVXXX(W(1,6),W(1,5),W(1,15),GAU,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL IOVXXX(W(1,9),W(1,5),W(1,7),GZU,AMP(43))
      CALL FVIXXX(W(1,1),W(1,7),GZU,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 44
      CALL IOVXXX(W(1,9),W(1,5),W(1,15),GAU,AMP(44))
      CALL FVIXXX(W(1,1),W(1,17),GZU,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 45
      CALL IOVXXX(W(1,15),W(1,5),W(1,13),GAU,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL IOVXXX(W(1,6),W(1,5),W(1,17),GZU,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL IOVXXX(W(1,15),W(1,5),W(1,7),GZU,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL IOVXXX(W(1,9),W(1,5),W(1,17),GZU,AMP(48))
      CALL FVIXXX(W(1,1),W(1,8),GAU,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 49
      CALL IOVXXX(W(1,17),W(1,2),W(1,13),GAU,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL IOVXXX(W(1,6),W(1,2),W(1,8),GAU,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL IOVXXX(W(1,17),W(1,2),W(1,7),GZU,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL IOVXXX(W(1,9),W(1,2),W(1,8),GAU,AMP(52))
      CALL FVIXXX(W(1,1),W(1,11),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 53
      CALL IOVXXX(W(1,8),W(1,2),W(1,13),GAU,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL IOVXXX(W(1,6),W(1,2),W(1,11),GZU,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL IOVXXX(W(1,8),W(1,2),W(1,7),GZU,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL IOVXXX(W(1,9),W(1,2),W(1,11),GZU,AMP(56))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)
     $ -AMP(8)-AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)-AMP(15)
     $ -AMP(16)-AMP(17)-AMP(18)-AMP(19)-AMP(20)-AMP(49)-AMP(50)-AMP(51)
