...
C     Amplitude(s) for diagram number 12
      ...
      CALL FVIXXX(W(1,6),W(1,7),GAD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,9),W(1,5),W(1,12),GAD,AMP(13))
      CALL FVOXXX(W(1,5),W(1,7),GAD,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,6),W(1,13),W(1,12),GAD,AMP(14))
      CALL JIOXXX(W(1,3),W(1,4),GZX11,ZMASS,ZWIDTH,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,9),W(1,5),W(1,7),GZD,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,6),W(1,13),W(1,7),GZD,AMP(16))
      CALL FVIXXX(W(1,6),W(1,10),GZD,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,13),W(1,5),W(1,12),GAD,AMP(17))
      CALL FVOXXX(W(1,5),W(1,10),GZD,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,6),W(1,9),W(1,12),GAD,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL IOVXXX(W(1,13),W(1,5),W(1,7),GZD,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,6),W(1,9),W(1,7),GZD,AMP(20))
