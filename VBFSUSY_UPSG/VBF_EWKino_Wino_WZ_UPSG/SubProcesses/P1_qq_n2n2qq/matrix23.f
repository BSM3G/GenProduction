...
C     Amplitude(s) for diagram number 10
      ...
      CALL JIOXXX(W(1,1),W(1,5),GAD,ZERO,AWIDTH,W(1,9))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FVIXXX(W(1,1),W(1,4),GAD,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL IOVXXX(W(1,6),W(1,5),W(1,10),GZD,AMP(15))
      CALL FVIXXX(W(1,1),W(1,10),GZD,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL IOVXXX(W(1,6),W(1,5),W(1,4),GAD,AMP(16))
      CALL FVIXXX(W(1,1),W(1,8),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 17
      CALL IOVXXX(W(1,4),W(1,5),W(1,10),GZD,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL IOVXXX(W(1,6),W(1,5),W(1,8),GZD,AMP(18))
