...
C     Amplitude(s) for diagram number 10
      ...
      CALL FVIXXX(W(1,2),W(1,9),GAD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GZD,AMP(11))
      CALL FVOXXX(W(1,6),W(1,9),GAD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,2),W(1,4),W(1,10),GZD,AMP(12))
      CALL FVIXXX(W(1,2),W(1,7),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GZD,AMP(13))
      CALL FVOXXX(W(1,6),W(1,7),GZD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,2),W(1,4),W(1,10),GZD,AMP(14))
      CALL JIOXXX(W(1,2),W(1,6),GAD,ZERO,AWIDTH,W(1,4))
