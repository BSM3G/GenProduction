...
C     ----------
      ...
      CALL JIOXXX(W(1,2),W(1,5),GAU,ZERO,AWIDTH,W(1,8))
      CALL FVOXXX(W(1,4),W(1,7),GWX1N1,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,3),W(1,9),W(1,8),GAX,AMP(1))
      CALL JIOXXX(W(1,2),W(1,5),GZU,ZMASS,ZWIDTH,W(1,10))
...
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,2),W(1,4),W(1,9),GWF,AMP(10))
      CALL FVIXXX(W(1,1),W(1,8),GAU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,4),W(1,6),W(1,9),GWF,AMP(11))
      CALL FVIXXX(W(1,1),W(1,9),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,4),W(1,6),W(1,8),GAD,AMP(12))
      CALL FVIXXX(W(1,1),W(1,10),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,8),W(1,6),W(1,9),GWF,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GZD,AMP(14))
