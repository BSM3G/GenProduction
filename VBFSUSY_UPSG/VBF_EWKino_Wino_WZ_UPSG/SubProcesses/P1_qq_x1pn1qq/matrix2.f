...
C     Amplitude(s) for diagram number 9
      ...
      CALL FVIXXX(W(1,2),W(1,7),GWF,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,11),W(1,6),W(1,9),GWF,AMP(10))
      CALL JIOXXX(W(1,1),W(1,6),GWF,WMASS,WWIDTH,W(1,11))
      CALL JIOXXX(W(1,2),W(1,5),GAD,ZERO,AWIDTH,W(1,7))
      CALL FVOXXX(W(1,4),W(1,11),GWX1N1,MX1,WX1,W(1,12))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,3),W(1,12),W(1,7),GAX,AMP(11))
      CALL JIOXXX(W(1,2),W(1,5),GZD,ZMASS,ZWIDTH,W(1,13))
...
C     Amplitude(s) for diagram number 20
      CALL IOVXXX(W(1,12),W(1,5),W(1,9),GWF,AMP(20))
      CALL FVIXXX(W(1,1),W(1,7),GAU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL IOVXXX(W(1,12),W(1,6),W(1,9),GWF,AMP(21))
      CALL FVIXXX(W(1,1),W(1,9),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,12),W(1,6),W(1,7),GAD,AMP(22))
      CALL FVIXXX(W(1,1),W(1,13),GZU,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 23
      CALL IOVXXX(W(1,7),W(1,6),W(1,9),GWF,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL IOVXXX(W(1,12),W(1,6),W(1,13),GZD,AMP(24))
      CALL FVIXXX(W(1,1),W(1,8),GAU,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 25
      CALL IOVXXX(W(1,13),W(1,5),W(1,9),GWF,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,12),W(1,5),W(1,8),GAD,AMP(26))
      CALL FVIXXX(W(1,1),W(1,10),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 27
      CALL IOVXXX(W(1,8),W(1,5),W(1,9),GWF,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL IOVXXX(W(1,12),W(1,5),W(1,10),GZD,AMP(28))
