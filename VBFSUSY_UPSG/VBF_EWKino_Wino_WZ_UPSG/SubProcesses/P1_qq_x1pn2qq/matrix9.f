...
C     Amplitude(s) for diagram number 9
      ...
      CALL FVIXXX(W(1,2),W(1,7),GAU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GWF,AMP(10))
      CALL FVOXXX(W(1,6),W(1,7),GAD,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,2),W(1,4),W(1,10),GWF,AMP(11))
      CALL FVIXXX(W(1,2),W(1,9),GZU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,4),W(1,6),W(1,10),GWF,AMP(12))
      CALL FVOXXX(W(1,6),W(1,9),GZD,ZERO,ZERO,W(1,4))
