...
C     Amplitude(s) for diagram number 9
      ...
      CALL FVIXXX(W(1,1),W(1,7),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,4),W(1,5),W(1,9),GWF,AMP(10))
      CALL FVIXXX(W(1,6),W(1,8),GAU,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,4),W(1,2),W(1,9),GWF,AMP(11))
      CALL FVIXXX(W(1,6),W(1,9),GWF,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL IOVXXX(W(1,4),W(1,2),W(1,8),GAD,AMP(12))
      CALL FVIXXX(W(1,6),W(1,10),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 13
      CALL IOVXXX(W(1,8),W(1,2),W(1,9),GWF,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL IOVXXX(W(1,4),W(1,2),W(1,10),GZD,AMP(14))
