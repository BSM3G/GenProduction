...
C     Amplitude(s) for diagram number 20
      ...
      CALL JIOXXX(W(1,1),W(1,6),GWF,WMASS,WWIDTH,W(1,14))
      CALL JIOXXX(W(1,2),W(1,5),GWF,WMASS,WWIDTH,W(1,15))
...
C     Amplitude(s) for diagram number 28
      ...
      CALL FVIXXX(W(1,2),W(1,14),GWF,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 29
      CALL IOVXXX(W(1,9),W(1,5),W(1,13),GAU,AMP(29))
      CALL FVOXXX(W(1,5),W(1,14),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 30
      CALL IOVXXX(W(1,2),W(1,12),W(1,13),GAD,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL IOVXXX(W(1,9),W(1,5),W(1,7),GZU,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL IOVXXX(W(1,2),W(1,12),W(1,7),GZD,AMP(32))
      CALL FVIXXX(W(1,1),W(1,15),GWF,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 33
      CALL IOVXXX(W(1,12),W(1,6),W(1,13),GAD,AMP(33))
      CALL FVIXXX(W(1,1),W(1,13),GAU,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 34
      CALL IOVXXX(W(1,2),W(1,6),W(1,15),GWF,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL IOVXXX(W(1,12),W(1,6),W(1,7),GZD,AMP(35))
      CALL FVIXXX(W(1,1),W(1,7),GZU,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 36
      CALL IOVXXX(W(1,12),W(1,6),W(1,15),GWF,AMP(36))
      CALL FVIXXX(W(1,1),W(1,8),GAU,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 37
      CALL IOVXXX(W(1,15),W(1,5),W(1,13),GAU,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL IOVXXX(W(1,2),W(1,5),W(1,8),GAU,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL IOVXXX(W(1,15),W(1,5),W(1,7),GZU,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL IOVXXX(W(1,12),W(1,5),W(1,8),GAU,AMP(40))
      CALL FVIXXX(W(1,1),W(1,11),GZU,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 41
      CALL IOVXXX(W(1,8),W(1,5),W(1,13),GAU,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL IOVXXX(W(1,2),W(1,5),W(1,11),GZU,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL IOVXXX(W(1,8),W(1,5),W(1,7),GZU,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL IOVXXX(W(1,12),W(1,5),W(1,11),GZU,AMP(44))
