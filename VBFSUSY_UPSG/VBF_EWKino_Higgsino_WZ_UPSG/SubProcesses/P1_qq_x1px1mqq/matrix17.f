...
C     Amplitude(s) for diagram number 22
      CALL IOVXXX(W(1,6),W(1,5),W(1,8),GAU,AMP(22))
...
C     Amplitude(s) for diagram number 26
      CALL IOVXXX(W(1,6),W(1,5),W(1,11),GZU,AMP(26))
