...
C     ----------
      ...
      CALL IXXXXX(P(0,4),MN2,NHEL(4),-1*IC(4),W(1,4))
      ...
      CALL FVOXXX(W(1,3),W(1,7),GWX1N2,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL IOVXXX(W(1,4),W(1,9),W(1,8),GWN2X1,AMP(1))
      CALL FVOXXX(W(1,3),W(1,7),GWX2N2,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL IOVXXX(W(1,4),W(1,9),W(1,8),GWN2X2,AMP(2))
      CALL FVICXX(W(1,4),W(1,7),GWX1N2,MX1,WX1,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL IOVCXX(W(1,9),W(1,3),W(1,8),GWN2X1,AMP(3))
      CALL FVICXX(W(1,4),W(1,7),GWX2N2,MX2,WX2,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL IOVCXX(W(1,9),W(1,3),W(1,8),GWN2X2,AMP(4))
      CALL JIOXXX(W(1,4),W(1,3),GZN22,ZMASS,ZWIDTH,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL VVVXXX(W(1,7),W(1,8),W(1,9),GWWZ,AMP(5))
      CALL HIOXXX(W(1,4),W(1,3),GH1N22,MH1,WH1,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL VVSXXX(W(1,7),W(1,8),W(1,10),GWWH1,AMP(6))
      CALL HIOXXX(W(1,4),W(1,3),GH2N22,MH2,WH2,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL VVSXXX(W(1,7),W(1,8),W(1,10),GWWH2,AMP(7))
      CALL FVIXXX(W(1,1),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL IOVXXX(W(1,10),W(1,2),W(1,9),GZU,AMP(8))
      CALL FVOXXX(W(1,2),W(1,7),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
      CALL IOVXXX(W(1,1),W(1,10),W(1,9),GZD,AMP(9))
      CALL FVIXXX(W(1,6),W(1,8),GWF,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 10
      CALL IOVXXX(W(1,10),W(1,5),W(1,9),GZD,AMP(10))
      CALL FVIXXX(W(1,6),W(1,9),GZU,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 11
      CALL IOVXXX(W(1,10),W(1,5),W(1,8),GWF,AMP(11))
